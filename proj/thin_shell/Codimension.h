...
{Typedef_VectorD(d);Typedef_VectorEi(4);typedef SimplicialMesh<d,4> Base;
public:
...
public:
	using Base::particles;using Base::mesh;using Base::invalid_particle_hashset;using Base::invalid_particle_heap;using Base::invalid_element_hashset;using Base::invalid_element_heap;
