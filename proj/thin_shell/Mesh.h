...
{Typedef_VectorD(d);using VectorEi=Vector4i;using Base=SimplicialMesh<d,4>;
public:
...
{Typedef_VectorD(d);using VectorEi=Vector3i;using Base=SimplicialMesh<d,3>;
public:
...
{Typedef_VectorD(d);using VectorEi=Vector2i;using Base=SimplicialMesh<d,2>;
public:
	using Base::vertices;using Base::elements;
...
{Typedef_VectorD(d);Typedef_VectorEi(4);using Base=SimplicialMesh<d,4>;
public:
	using Base::vertices;using Base::elements;
...
{Typedef_VectorD(d);Typedef_VectorEi(Pow(2,d));using Base=SimplicialMesh<d,Pow(2,d)>;
public:
	using Base::vertices;using Base::elements;
...
{Typedef_VectorD(d);Typedef_VectorEi(Pow(2,d-1));using Base=SimplicialMesh<d,Pow(2,d-1)>;
public:
	using Base::vertices;using Base::elements;
