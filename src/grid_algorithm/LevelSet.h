//////////////////////////////////////////////////////////////////////////
// Level set
// Copyright (c) (2022-), Zhiqi Li, Bo Zhu, Xingyu Ni
...
//			VectorDi correct_axis = VectorDi::Zero();
//			for (int j = 0; j < 2 * d; j++) {
//				VectorDi nb = grid_ptr->Neighbor_Node(cell, j);
...
//					int axis = grid_ptr->Neighbor_Axis(j);
//					correct_axis[axis] = 1;
...
//			VectorDi correct_axis = VectorDi::Zero();
//			for (int i = 0; i < 2 * d; i++) {
//				VectorDi nb = grid_ptr->Neighbor_Node(cell, i);
//				if (!grid_ptr->Valid(nb)) continue;
//				const int nb_idx = grid_ptr->Index(nb);
//				if (done_local_ptr[nb_idx]==1) {
//					int axis = grid_ptr->Neighbor_Axis(i);
//					correct_axis[axis] = 1;
